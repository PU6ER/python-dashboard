                        ...
                        dbc.Col([
                            dbc.CardBody([
                                ...
                                style={'display': 'inline-block', 'marginRight': '5px'}
                                 ...
                                 html.Span("ед.",style={'display': 'inline-block'}) 
                                 ]
                        )], width= 8),
                    ])
                ], color = "success", outline=True, style={'textAlign': 'center'}),],width=3),
        dbc.Col([dbc.Card([
                    dbc.Row([
                        ...
                        dbc.Col([
                            dbc.CardBody([
                                ...
                                style={'display': 'inline-block', 'marginRight': '5px'}
                                 ...
                                 html.Span("чел.",style={'display': 'inline-block'}) 
                                 ]
                    )], width= 8),
                    ])
    ...
    dbc.Container([
        dbc.Row ([
            ...
            dbc.Col([
                ...
                html.Br(),
                dbc.Row([html.H5("ТОП-5 стран по ВВП"),
                         html.Div(id="table1")], style={'textAlign':'center'})
            ],width=4)
        ]),
    ])
