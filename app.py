...
from pages import all_map, country, indicators, salary


external_stylesheets = [dbc.themes.PULSE]  # Вместо FLATLY выберите свою тему из https://bootswatch.com/
...
SIDEBAR_STYLE = {
    ...
    "padding": "2rem 1rem",
    "color": "#ffffff",
    "background-color": "#242424", # Цвет фона боковой панели меняем на тот, который больше всего подходит
}
    ...
    [
        ...
        dbc.Nav(
            [
                ...
                dbc.NavLink("Зарплаты", href="/page-3", active="exact"),
            ],
            vertical=True,
            pills=True,
        ),
